...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '0b2e50587712572b8853b5725b7a5bd12feca51c349b59f0e3cd0202a1061fe2_1' => 'get0b2e50587712572b8853b5725b7a5bd12feca51c349b59f0e3cd0202a1061fe21Service',
            '0b2e50587712572b8853b5725b7a5bd12feca51c349b59f0e3cd0202a1061fe2_2' => 'get0b2e50587712572b8853b5725b7a5bd12feca51c349b59f0e3cd0202a1061fe22Service',
            '0b2e50587712572b8853b5725b7a5bd12feca51c349b59f0e3cd0202a1061fe2_3' => 'get0b2e50587712572b8853b5725b7a5bd12feca51c349b59f0e3cd0202a1061fe23Service',
            '7c786e2805e23590c9890b82be92d38a8e44faafda07f0c063efae8977cedac1_1' => 'get7c786e2805e23590c9890b82be92d38a8e44faafda07f0c063efae8977cedac11Service',
    ...
    /**
     * Gets the '0b2e50587712572b8853b5725b7a5bd12feca51c349b59f0e3cd0202a1061fe2_1' service.
     *
     ...
     */
    protected function get0b2e50587712572b8853b5725b7a5bd12feca51c349b59f0e3cd0202a1061fe21Service()
    {
        return $this->services['0b2e50587712572b8853b5725b7a5bd12feca51c349b59f0e3cd0202a1061fe2_1'] = new \Swift_Transport_Esmtp_Auth_CramMd5Authenticator();
    }

    /**
     * Gets the '0b2e50587712572b8853b5725b7a5bd12feca51c349b59f0e3cd0202a1061fe2_2' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get0b2e50587712572b8853b5725b7a5bd12feca51c349b59f0e3cd0202a1061fe22Service()
    {
        return $this->services['0b2e50587712572b8853b5725b7a5bd12feca51c349b59f0e3cd0202a1061fe2_2'] = new \Swift_Transport_Esmtp_Auth_LoginAuthenticator();
    }

    /**
     * Gets the '0b2e50587712572b8853b5725b7a5bd12feca51c349b59f0e3cd0202a1061fe2_3' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get0b2e50587712572b8853b5725b7a5bd12feca51c349b59f0e3cd0202a1061fe23Service()
    {
        return $this->services['0b2e50587712572b8853b5725b7a5bd12feca51c349b59f0e3cd0202a1061fe2_3'] = new \Swift_Transport_Esmtp_Auth_PlainAuthenticator();
    }

    /**
     * Gets the '7c786e2805e23590c9890b82be92d38a8e44faafda07f0c063efae8977cedac1_1' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get7c786e2805e23590c9890b82be92d38a8e44faafda07f0c063efae8977cedac11Service()
    {
        return $this->services['7c786e2805e23590c9890b82be92d38a8e44faafda07f0c063efae8977cedac1_1'] = new \Symfony\Component\Form\ResolvedFormTypeFactory();
    }
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/xampp/htdocs/Championnat/app/cache/dev/annotations', true);
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/xampp/htdocs/Championnat/app/Resources');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_6bdacb4e566e2a41d19bf79e300aa1db28a1715095ec52f4fdc870adb04103c5');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_6bdacb4e566e2a41d19bf79e300aa1db28a1715095ec52f4fdc870adb04103c5');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_6bdacb4e566e2a41d19bf79e300aa1db28a1715095ec52f4fdc870adb04103c5');
        ...
        $d->setProxyDir('C:/xampp/htdocs/Championnat/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/xampp/htdocs/Championnat/app/Resources');
    }
    ...
    {
        return $this->services['form.resolved_type_factory'] = new \Symfony\Component\Form\Extension\DataCollector\Proxy\ResolvedTypeFactoryDataCollectorProxy($this->get('7c786e2805e23590c9890b82be92d38a8e44faafda07f0c063efae8977cedac1_1'), $this->get('data_collector.form'));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/xampp/htdocs/Championnat/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/xampp/htdocs/Championnat/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/xampp/htdocs/Championnat/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/xampp/htdocs/Championnat/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/xampp/htdocs/Championnat/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/xampp/htdocs/Championnat/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/xampp/htdocs/Championnat/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        $a = new \Swift_Transport_Esmtp_AuthHandler(array(0 => $this->get('0b2e50587712572b8853b5725b7a5bd12feca51c349b59f0e3cd0202a1061fe2_1'), 1 => $this->get('0b2e50587712572b8853b5725b7a5bd12feca51c349b59f0e3cd0202a1061fe2_2'), 2 => $this->get('0b2e50587712572b8853b5725b7a5bd12feca51c349b59f0e3cd0202a1061fe2_3')));
        $a->setUsername(NULL);
        $a->setPassword(NULL);
        $a->setAuthMode(NULL);
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/xampp/htdocs/Championnat/app', 'UTF-8');
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/xampp/htdocs/Championnat/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/xampp/htdocs/Championnat/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\xampp\\htdocs\\Championnat\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\xampp\\htdocs\\Championnat\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\xampp\\htdocs\\Championnat\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\xampp\\htdocs\\Championnat\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\xampp\\htdocs\\Championnat\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\xampp\\htdocs\\Championnat\\src\\Acme\\DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('C:\\xampp\\htdocs\\Championnat\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\xampp\\htdocs\\Championnat\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('C:/xampp/htdocs/Championnat/app/Resources/views');
        $instance->addPath('C:\\xampp\\htdocs\\Championnat\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => 'C:\\xampp\\htdocs\\Championnat\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/xampp/htdocs/Championnat/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/xampp/htdocs/Championnat/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/xampp/htdocs/Championnat/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/xampp/htdocs/Championnat/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/xampp/htdocs/Championnat/app/cache/dev',
            'kernel.logs_dir' => 'C:/xampp/htdocs/Championnat/app/logs',
            ...
            'debug.container.dump' => 'C:/xampp/htdocs/Championnat/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'C:/xampp/htdocs/Championnat/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:C:/xampp/htdocs/Championnat/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/xampp/htdocs/Championnat/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/xampp/htdocs/Championnat/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/xampp/htdocs/Championnat/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/xampp/htdocs/Championnat/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/xampp/htdocs/Championnat/app/../web',
            'assetic.write_to' => 'C:/xampp/htdocs/Championnat/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/xampp/htdocs/Championnat/app/cache/dev/doctrine/orm/Proxies',
